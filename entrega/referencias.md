...
1. Brown, Simon. *The C4 model for visualising software architecture*. c4model.com. https://c4model.com/
2. Guía paso a paso del taller: `clase/guia_paso_a_paso_c4.md` (notación C1/C2, metodología de 4 pasos y ejemplo guiado sobre RedExpress).

---

## 📌 Nota

Esta entrega corresponde a la **Parte 1 (Trabajo en Clase)** del taller, desarrollada íntegramente sobre el caso base RedExpress provisto en la guía. La investigación complementaria sobre arquitecturas C4 aplicadas al sector del cliente real (solicitada en la Parte 2) queda pendiente para la siguiente entrega.
